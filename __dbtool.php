...
DROP TABLE IF EXISTS user_weigh_in;
...
INSERT INTO users(user_id, sessionid, user_name, user_email, user_pass, join_date) VALUES( 1, 'X', 'kyle', 'kyle.brazell@ymail.com', '$2y$10$BbEIYQUUFMD7GwCQYWWqsuagDJjjDxdlirOnVTwMIugNrNXEM4o9i', '2016-08-31 11:53:26');
INSERT INTO users(user_id, sessionid, user_name, user_email, user_pass, join_date) VALUES( 2, 'X', 'bogus1', 'bogus1@bogus.org', '$2y$10$1PNKvjHzM2ol5u9b.tbmI.J3.WRaDbz3v/bxR1urQFl4/WYrLj0la', '2016-08-31 12:00:00');
INSERT INTO users(user_id, sessionid, user_name, user_email, user_pass, join_date) VALUES( 3, 'X', 'bogus2', 'bogus2@bogus.org', '$2y$10$zpc19DIPR1vcpjM44bf7UOSWHGHW5TL7JD09JPTMC0bzjBzBMI79q', '2016-08-31 13:00:00');
...
(
 ...
 ,CONSTRAINT FOREIGN KEY (fk_created_by) REFERENCES users(user_id)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;
